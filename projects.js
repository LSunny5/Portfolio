//store for projects for portfolio
const PROJECTS = [
    //Projects
    {
        number: 1,
    ...
    //Projects
    {
        ...
        alt: 'Screenshot of the TipsDeck App',
        description: 'Life is always full of little problems and life hacks always make life easier in handling those problems.  TipsDeck is a site where you can search through life hacks and find just the hack you need by using a search term.  I built this so that I could search and find just the right hack I need without going through multiple sites. <br /><br />***If failed to fetch, please wait 1-2 min for server to start up then on refresh, app data will load properly.  Thank you!***',
        repo: 'https://github.com/LSunny5/TipsDeck-App', 
        livepage: 'https://tipsdeck.now.sh/'
    },
    ...
    //Projects
    {
        ...
        tech: ['react', 'node', 'express', 'postgresql', 'html5', 'css3', 'javascript'], 
        techlist: 'Tech Used: React, Node.js, Express, PostgreSQL, HTML5, CSS3, JavaScript',
        screenshot: 'images/NotefulSS2.png', 
        alt: 'Noteful Application Home screenshot',
        description: 'An application to hold all your notes!  Notes are organized in folders, and can be great to record a quick memo.  This app was created for fun and part of my educational journey.<br /><br />***If failed to fetch, please wait 1-2 min for server to start up then on refresh, app data will load properly.  Thank you!***',
        repo: 'https://github.com/LSunny5/noteful', 
        livepage: 'https://noteful-app-jade.now.sh/'
    },

    //API Capstone Project
    {
        number: 4,
        title: 'Drug Price Compare App', 
        tech: ['html5', 'css3', 'javascript', 'jquery'], 
        techlist: 'Tech Used: HTML5, CSS3, JavaScript, JQuery',
    ...
    //Quiz project
    {
        ...
        tech: ['html5', 'css3', 'javascript', 'jquery'], 
        techlist: 'Tech Used: HTML5, CSS3, JavaScript, JQuery',
        screenshot: 'images/princessQuiz.png', 
        alt: 'Disney Princess Quiz App Screenshot of Question',
        description: ' Take this quiz to find out how well you know some of the Disney Princesses, but watch out! If you do badly, Ursula waits!  This quiz is a fun test for anyone young at heart on their knowledge about the princesses.  I built it for my daughters who love Disney Princess trivia.',
        repo: 'https://github.com/LSunny5/QuizApp', 
        livepage: 'https://lsunny5.github.io/QuizApp/'
    },

    //Child Health Vital Website
    {
        number: 6,
        title: 'Child Health Vital', 
        tech: ['html5', 'css3', 'javascript'], 
        techlist: 'Tech Used: HTML5, CSS3, JavaScript',
    ...
    //My Personal Health Chart Mobile App Website
    {
        ...
        tech: ['html5', 'css3', 'javascript', 'android'], 
        techlist: 'Tech Used: HTML5, CSS3, JavaScript, Android',
